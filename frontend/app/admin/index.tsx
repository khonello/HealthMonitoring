...
const TILES: Tile[] = [
  { key: 'total_users', label: 'Total Users', route: '/admin/users', accentWhenNonZero: 'neutral' },
  { key: 'critical_last_24h', label: 'Critical (24h)', route: '/admin/triage?filter=critical_urgent', accentWhenNonZero: 'critical' },
  { key: 'hard_rule_last_24h', label: 'Hard-Rule Overrides (24h)', route: '/admin/triage?filter=hard_rule', accentWhenNonZero: 'critical' },
  { key: 'low_confidence_last_24h', label: 'Low Confidence (24h)', route: '/admin/triage?filter=low_confidence', accentWhenNonZero: 'caution' },
  { key: 'llm_failures_last_24h', label: 'LLM Failures (24h)', route: '/admin/llm-health', accentWhenNonZero: 'alert' },
  { key: 'new_feedback', label: 'New Feedback', route: '/admin/feedback?status=new', accentWhenNonZero: 'caution' },
];
          ...
          >
            <GlassCard style={styles.navRow}>
              ...
              <View style={styles.navText}>
                ...
                <Text style={styles.navSubtitle}>Edit hard-rule thresholds and the report disclaimer</Text>
              </View>
              <Ionicons name="chevron-forward" size={18} color={Colors.textTertiary} />
            </GlassCard>
          </Pressable>
...
const styles = StyleSheet.create({
  ...
  tileLabel: { fontFamily: Font.sansMedium, fontSize: 12, color: Colors.textSecondary },
